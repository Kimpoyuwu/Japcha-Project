    ...
    <div class="stat-container" >
        ...
        <div class="statistics" id = "statistics">
            ...
            <div class="graph-content" id = "sales-cont" >
                ...
                <div class="data--cont">
                    <div class="data-box">
                        <p class = "data-tag">Past Revenue</p>
                    ...
                    <div class="data-box">
                        ...
                        <h2 class = "data-value" id = "current-rev">10-18-23</h2>
                    </div>
        ...
        <div class="print-btn">
            <button class = "printBtn" onclick = "printStatistic()">
...
<script>
    ...
    function printStatistic() {
            ...
            var divContent = document.getElementById('statistics').innerHTML;
            
            // Create a new div element to display the content
            var printWindow = window.open('', '', 'width=1200, height=2000');
            printWindow.document.open();
            printWindow.document.write('<html><head><title>Japcha Statistics</title></head><body>');
            printWindow.document.write('<pre>' + divContent + '</pre>');
