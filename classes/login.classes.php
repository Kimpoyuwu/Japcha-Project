...
class Login extends Dbh {
    ...
    public function adminLogin($email, $pwd) {
        try {
            // Prepare SQL query using named placeholders
            $stmt = $this->connect()->prepare('SELECT a.admin_id, a.email, a.username, a.contact, a.password, a.userlevel_id,  ul.* FROM admin_account a INNER JOIN user_level ul ON a.userlevel_id = ul.userlevel_id WHERE username = :username');
