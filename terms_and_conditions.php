    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="card-text">
                ...
                [company name] only grants use and access to this website, its products, and services to those who have accepted its terms.
            </p>

            <h4 class="card-title">Privacy Policy</h4>
            <p class="card-text">
                Before you continue using our website, we advise you to read our <a href="#linkToPrivacyPolicy">privacy policy</a> regarding our user data collection.
            ...
            <p class="card-text">
                ...
                By using this website, you warrant that you are at least 18 years of age and may legally adhere to this Agreement.
                [company name] assumes no responsibility for liabilities related to age misrepresentation.
            </p>
            ...
            <p class="card-text">
                [company name] reserves the right to edit, modify, and change this Agreement at any time.
                We shall let our users know of these changes through electronic mail.
                This Agreement is an understanding between [company name] and the user, and this supersedes and replaces all prior agreements regarding the use of this website.
            </p>
