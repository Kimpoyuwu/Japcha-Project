...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if (isset($_POST['SaveButton'])) {
        ...
        $insertCoupon->insertCoupon($getCouponCode,$getOfferName,$getDiscount,$formattedStartTime,$formattedEndTime);
    ...
    if (isset($_POST['ConfirmButton'])) {
        ...
        $editCoupon->editCoupon($editCouponCode,$editOfferName,$editDiscount,$formattedStartTime,$formattedEndTime,$couponID);
